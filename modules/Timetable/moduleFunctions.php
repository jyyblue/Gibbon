...
function renderTTDay($guid, $connection2, $gibbonTTID, $schoolOpen, $startDayStamp, $count, $daysInWeek, $gibbonPersonID, $gridTimeStart, $eventsSchool, $eventsPersonal, $eventsSpaceBooking, $activities, $staffDuty, $staffCoverage, $diffTime, $maxAllDays, $narrow, $specialDayStart = '', $specialDayEnd = '', $specialDay = [], $roleCategory = '', $edit = false)
{
    ...
    $dayOfWeek = date('l', ($startDayStamp + (86400 * $count)));
        ...
        if ($resultDay->rowCount() == 1) {
            ...
            if(true){
                try {
                    ...
                    // 2024-08-19 Liu
                    // get course time slots this day, for this user.

                    $dataPeriods = array('gibbonPersonID' => $gibbonPersonID, 'gibbonSchoolYearID' => $gibbonSchoolYearID, 'dayOfWeek' => $dayOfWeek);
                    $sqlPeriods = "SELECT 
                        gibbonCourse.nameShort as course, gibbonCourse.gibbonCourseID, gibbonCourse.gibbonYearGroupIDList,
                        gibbonCourseClass.nameShort as class,gibbonCourseClass.gibbonCourseClassID,
                        gibbonClassColumnRow.name, gibbonClassColumnRow.timeStart, gibbonClassColumnRow.timeEnd,gibbonClassColumnRow.gibbonClassColumnRowID,
                        gibbonSpace.name as roomName , gibbonSpace.gibbonSpaceID , phoneInternal
                        FROM gibbonCourseClass
                        JOIN gibbonCourseClassPerson ON (gibbonCourseClass.gibbonCourseClassID=gibbonCourseClassPerson.gibbonCourseClassID) 
                        JOIN gibbonCourse ON (gibbonCourse.gibbonCourseID=gibbonCourseClass.gibbonCourseID) 
                        LEFT JOIN gibbonClassColumn on gibbonCourseClass.gibbonCourseClassID=gibbonClassColumn.gibbonCourseClassID
                        JOIN gibbonDaysOfWeek on gibbonClassColumn.gibbonDaysOfWeekID=gibbonDaysOfWeek.gibbonDaysOfWeekID
                        LEFT JOIN gibbonClassColumnRow ON gibbonClassColumn.gibbonClassColumnID=gibbonClassColumnRow.gibbonClassColumnID
                        ...
                        GROUP BY gibbonClassColumnRow.gibbonClassColumnRowID
                        ...
                        if ( true || $isCovering) {
                            ...
                            if ($rowPeriods['roomName'] != '') {
                                if ($height < 30) {
                                    ...
                                    // 2024-09-01 Liu: just show roomName. roomChange should be considered.
                                ...
                                if ($rowPeriods['phoneInternal'] != '') {
                                    ...
                                    // 2024-09-01 Liu : just comment for gibbonTTDayRowClassID
                            ...
                            if ($classCount > 1) {
                                // 2024-09-01 Liu: exception should be considered.
                            ...
                            if ($height >= 30) {
                                if ($offTimetableClass) {
                                    ...
                                    // 2024-09-01 Liu: space change should be considered
                                    // if (isset($spaceChanges[$rowPeriods['gibbonTTDayRowClassID']]) == false) {
                                    //     $output .= $rowPeriods['roomName'];
                                    // } else {
                                    //     if ($spaceChanges[$rowPeriods['gibbonTTDayRowClassID']][0] != '') {
                                    ...
                                    // 2024-09-01 Liu: Manage Exception
                                        ...
                                        if ($height >= 30) {
                                            ...
                                            if (!empty($rowPeriods['gibbonCourseClassID'])) {
                                                ...
                                                if ($resultPlan->rowCount() == 1) {
                                                    ...
                                                    // 0000000061 gibbonTTDayID
                                                    // 0000000001 gibbonPersonID
                                                    // 2024-08-19 date
